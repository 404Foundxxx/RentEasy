...
public class ControladorEditarPerfil {
    ...
    private FrmEditarPerfilPropietario frmEditarPerfilUsuario;
    private UsuarioDAO usuarioDAO;
    private Usuario usuarioActual;

    public ControladorEditarPerfil(FrmEditarPerfilPropietario frmEditarPerfilPropietario) {
        this.frmEditarPerfilUsuario = frmEditarPerfilPropietario;
     ...
     */
    public FrmEditarPerfilPropietario getVista() {
